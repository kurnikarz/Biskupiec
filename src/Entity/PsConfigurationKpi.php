 ...
 * PsConfigurationKpi
 *
 * @ORM\Table(name="ps_configuration_kpi", indexes={@ORM\Index(name="id_shop_group", columns={"id_shop_group"}), @ORM\Index(name="name", columns={"name"}), @ORM\Index(name="id_shop", columns={"id_shop"})})
 * @ORM\Entity
 */
